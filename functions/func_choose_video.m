...
try
    app.drop_number_videos.Value = value;
    ...
    app.txt_video_event.Value = selected_events.Type{value};
    if length(selected_events.Index) == 1
        app.num_video_event_index.Value = selected_events.Index;
    else
        app.num_video_event_index.Value = selected_events.Index(value);
    end
    ...
    % Add a dashed line
    color_light_brown = '#c39d85';
    color_dark_brown = '#532915';
    hold(app.axis_spectrogram,'on');
    ylim = get(app.axis_spectrogram,'ylim');
    h_line_2 = plot(app.axis_spectrogram,[0,0],ylim,'-','linewidth',2,'color',color_dark_brown);
    h_line = plot(app.axis_spectrogram,[0,0],ylim,'--','linewidth',2,'color',color_light_brown);
    setappdata(app.hand_editing,'h_line',h_line);
    setappdata(app.hand_editing,'h_line_2',h_line_2);
    ...
    errordlg(ME.message, 'func_choose_video');
end